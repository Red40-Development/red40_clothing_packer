...
public interface IRepackerWorkflow
{
    ...
    Task<DiagnosticBundleResult> CreateDiagnosticBundleAsync(IReadOnlyList<string> resourceFolders, string outputPath, IProgress<OperationProgress> progress, CancellationToken cancellationToken);
